...
const UserColocationCoverSection = () => {
  const { i18n } = useLingui()
  return (
    <UserCover title={i18n._(t`Co-location`)} description="Private Co-location at Data Center">
      <UserContainer
        className={clsx(
      ...
      >
        ...
        <img
          ...
          className={clsx(`absolute bottom-[-120px] left-[-275px] w-[617px]`)}
        />
...
export default UserColocationCoverSection
