...
export const Page = () => {
  ...
  return (
    <Fragment>
      <UserTermsHeroSection title={i18n._(t`Terms of Service`)} />
      <section className={clsx(`pb-14 pt-8`)}>
        <UserContainer>
          <div className={clsx(`text-content`)}>
            <h2>Terms and Conditions</h2>
            <p>Last updated: September 28, 2021</p>
            ...
            <ul>
              ...
              <li>
                ...
                refers to OLUFY CO., LTD., 138/37 Soi Ladprao 41 Intersection 6-9, Ladprao Road, Chankasem, Chatuchak,
                Bangkok 10230
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to OLUFY CO., LTD., accessible from{' '}
                <a href="https://olufy.com/" rel="external nofollow noopener" target="_blank">
                  https://olufy.com/
                </a>
              </li>
              <li>
            ...
            <ul>
              <li>By email: info@olufy.com</li>
              <li>
                By visiting this page on our website:{' '}
                <a href={`https://olufy.com/${lang}/contact`} rel="external nofollow noopener" target="_blank">
                  https://olufy.com/{lang}/contact
                </a>
              </li>
            </ul>
          </div>
