...
export const Page = () => {
  ...
  const routeBack = useMemo(() => {
    ...
    return `/app/dedicated-server/packages/${routeParams?.id}?${params}`
      ...
      <Card className={clsx(`mt-6 p-0`, `sm:mt-4`)}>
        ...
        <div className={clsx(`p-4`)}>
          <div className={clsx(`flex items-center justify-between`)}>
            <span className={clsx(`text-header-3`, `lg:text-header-5`)}>Dedicated Game Server</span>
            <span className={clsx(`text-header-3`, `lg:text-header-5`)}>3,500.00 THB</span>
          </div>
          <div className={clsx(`flex items-center justify-between`)}>
            <span className={clsx(`text-body-16`, `lg:text-body-14`)}>Enterprise server</span>
          ...
          <div className={clsx(`flex items-center justify-between`)}>
            ...
            <div className={clsx(`flex items-center divide-x`, `lg:flex-col lg:items-end lg:divide-x-0`)}>
              ...
              <Link
                href="/app/dedicated-server/packages"
