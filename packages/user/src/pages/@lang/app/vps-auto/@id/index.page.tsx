...
export const Page = () => {
  ...
  return (
    <Fragment>
      <BackButton as="a" href={`/app/auto-vps`} />
      ...
      <Card className={clsx(`mt-6 p-0`)}>
        <div className={clsx(`flex space-x-6 p-6`, `sm:space-x-3`)}>
          ...
          <div>
            <h4 className={clsx(`text-header-3`, `sm:text-header-4`)}>{i18n._(t`VPU Auto SSD #`)}</h4>
            <p className={clsx(`text-body-16 font-light`)}>{i18n._(t`(2 CPU vCore)`)}</p>
