...
export const Page = () => {
  ...
  const routeBack = useMemo(() => {
    ...
    return `/app/license-key/packages`
  }, [urlParsed.search])
      ...
      <Card className={clsx(`mt-6 p-0`, `sm:mt-4`)}>
        ...
        <div className={clsx(`p-4`)}>
          <div className={clsx(`flex items-center justify-between`)}>
            <span className={clsx(`text-header-3`, `lg:text-header-5`)}>Privilege edit</span>
            <span className={clsx(`text-header-3`, `lg:text-header-5`)}>300.00 THB</span>
          </div>
          <div className={clsx(`flex items-center justify-between`)}>
            <span className={clsx(`text-body-16`, `lg:text-body-14`)}>Edit license key</span>
          </div>
